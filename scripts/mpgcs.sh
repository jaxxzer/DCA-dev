...
gnome-terminal -e "python /home/jack/git/MAVProxy/MAVProxy/mavproxy.py --target-system=1 --target-component=1 --master=0.0.0.0:14551 --out=udp:0.0.0.0:14550 --load-module=DGPS --aircraft=ROV_LOGS"
sleep 2
